<template>
  <div class="contact">
    <v-container class="form my-8">
      ...
      <div>
        <div class="display-1 mb-4" style="line-height: 1;">Leave Us Message</div>
        <v-form v-model="valid" class="primary--text d-flex flex-column" style="grid-gap: 20px;" lazy-validation ref="form">
          ...
          <div class="form__div">
            ...
            <v-select v-model="item.type" outlined dense hide-details label="Please Select*" :rules="[ v => !!v || '' ]" />
          </div>
